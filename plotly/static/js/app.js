...
function plotID (id) {
    ...
    d3.json("samples.json").then(data => {
        ...
        demographicData.append('p').text(`Total Cases: ${selectionMeta[0].ethnicity}`);
        demographicData.append('p').text(`Total Deaths: ${selectionMeta[0].gender}`);
        demographicData.append('p').text(`New Cases (date): ${selectionMeta[0].age}`);
        demographicData.append('p').text(`New Deaths (date): ${selectionMeta[0].location}`);
